...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint32_t CRYPTONOTE_MAX_BLOCK_NUMBER = 250000000;

        const size_t CRYPTONOTE_MAX_BLOCK_BLOB_SIZE = 250000000;

        const size_t CRYPTONOTE_MAX_TX_SIZE = 500000000;

        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x29b79d;
    ...
    const char CRYPTONOTE_NAME[] = "TribalCoin";
    ...
    const int RPC_DEFAULT_PORT = 16370;

    const int SERVICE_DEFAULT_PORT = 8090;
    ...
    const static boost::uuids::uuid CRYPTONOTE_NETWORK = {
        {0xb1, 0x2c, 0x3a, 0x4c, 0xcf, 0x52, 0x67, 0x71, 0x85, 0xf9, 0x10, 0x11, 0xb6, 0xc1, 0x43, 0xe9}};

    const char *const SEED_NODES[] = {
        "111.11.11.11:16369", // Khasi
        "222.22.22.22:16369", // Liah
    };
} // namespace CryptoNote
